/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bc9dd663386446ab95df380d2c7a77a0)
// Runtime types generated with workerd@1.20260210.0 2025-08-12 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		TBOOK_AUTH_TOKEN: string;
		BtcIndexer: Service /* entrypoint RPCMock from btcindexer */;
		SuiIndexer: Service /* entrypoint RPCMock from sui-indexer */;
	}
	interface ProdEnv {
		BeelieversNFT: KVNamespace;
		BeelieversD1: D1Database;
		...
		TRADEPORT_API_KEY: string;
		TBOOK_AUTH_TOKEN: string;
		BtcIndexer: Service /* entrypoint RPC from btcindexer-prod */;
		SuiIndexer: Service /* entrypoint RPC from sui-indexer-prod */;
	}
	interface Env {
		TRADEPORT_API_USER: string;
		TRADEPORT_API_KEY: string;
		...
		BeelieversD1: D1Database;
		BYieldD1: D1Database;
		BtcIndexer: Service /* entrypoint RPCMock from btcindexer */ | Service /* entrypoint RPC from btcindexer-prod */ | Service /* entrypoint RPC from btcindexer */;
		SuiIndexer: Service /* entrypoint RPCMock from sui-indexer */ | Service /* entrypoint RPC from sui-indexer-prod */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRADEPORT_API_USER" | "TRADEPORT_API_KEY" | "TBOOK_AUTH_TOKEN">> {}
}
