...
export function Instructions() {
	...
	return (
		<Card className="p-4 bg-azure-10 rounded-2xl card-border border md:bg-[url('/assets/bee/bee-with-question-mark.webp')] bg-no-repeat bg-right-bottom bg-[length:min(150px,100%)]">
			<Card.Body className="flex flex-col justify-between p-0">
