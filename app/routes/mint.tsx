...
import { BitcoinTransactionStatus, type MintTransaction } from "~/server/Mint/types";
...
const data: MintTransaction[] = [
	{
		...
		status: BitcoinTransactionStatus.SUCCESS,
