...
function DepositCard({ title, value }: DepositData) {
	return (
		<Card className="flex flex-1 max-w-1/4 card-border border rounded-lg">
			<Card.Body className="p-6 rounded-lg text-white flex flex-col gap-2 bg-azure-10 w-full">
