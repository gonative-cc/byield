	...
	return (
		...
		>
			<button
				...
				className="link link-primary from-primary/10 to-primary/5 hover:from-primary/20 hover:to-primary/10 flex w-full items-center justify-between bg-gradient-to-r p-4 text-left text-lg !no-underline lg:p-6 lg:text-xl"
			>
